# Inspired by: https://github.com/rob-blackbourn/medium-queue-logging/blob/master/examples/queue_listener_handler.py
...
def _resolve_handlers(l):
    ...
    for i in range(len(l)):
        _handlers.append(l.configurator.config.get('handlers').get(l[i]))
    return _handlers
